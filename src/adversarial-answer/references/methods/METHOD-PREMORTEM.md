...
原典は 1989 年の心理学実験であり、本 Skill の適用対象 (実務上の計画レビュー) とは対象が異なる。加えて原典 PDF を取得できていないため、本 Card は prospective hindsight (未来の出来事が既に発生したものとして説明させる) という枠組みの記述にのみ依拠している。「Premortem を行えば失敗を予防できる」という主張はしない。
