...
| 12 | `[成果物の声]` の項目が `deliverable_voice` に従い、記録欄 (`resume_check` など) が作業言語のままか。読解水準に合わない語彙で手順が書かれていないか | I-15 |

## 判定

- 観点 1・3・9・10 は `CRITICAL`。観点 2・4〜7・12 は `MAJOR`。観点 8・11 は `MINOR`
